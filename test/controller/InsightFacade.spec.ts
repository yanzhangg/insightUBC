...
describe("InsightFacade", function () {
	...
	const datasetsToLoad: {[key: string]: string} = {
		...
		noIndex: "./test/resources/archives/rooms-no-index.zip",
		noRooms: "./test/resources/archives/rooms-no-rooms.zip",
		noValidRooms: "./test/resources/archives/rooms-no-valid-rooms.zip",
		noDiscover: "./test/resources/archives/rooms-nodiscover.zip",
		notHTM: "./test/resources/archives/rooms-not-htm.zip",
	...
	describe("Add/Remove/List Dataset", function () {
		...
		it("Should throw an InsightError for rooms empty dataset", function () {
		...
		it("Should throw an InsightError for no valid rooms dataset", function () {
			const id: string = "noValidRooms";
			const content: string = datasetContents.get("noValidRooms") ?? "";
		...
		it("Should throw an InsightError for rooms with no discover file", function () {
			const id: string = "noDiscover";
			const content: string = datasetContents.get("noDiscover") ?? "";
	...
	describe("PerformQuery", () => {
		...
		// 			// 	WHERE: {},
		// 			// 	OPTIONS: {
		// 			// 		COLUMNS: ["twoCourses_title", "twoCourses_year", "overallCount", "overallAvg"]
		// 			// 	 },
		// 			// 	TRANSFORMATIONS: {
		// 			// 		GROUP: ["twoCourses_title", "twoCourses_year"],
		// 			// 		APPLY: [{
		// 			// 			overallAvg: {
		// 			// 				 AVG: "twoCourses_avg"
		// 			// 			 }
